...
coincidences_all = analyzer.find_coincidences(dt_window_ns=dt_window)

# Energy selection
range0 = select_energy_range(df, channel=0, bins=1000, energy_range=(0, 50000))
range1 = select_energy_range(df, channel=1, bins=2000, energy_range=(0, 50000), coincidences=coincidences_all)

# Coincidence analysis
coincidences_in_range = analyzer.find_coincidences(
